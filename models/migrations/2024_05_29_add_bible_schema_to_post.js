...
var post_1 = require("../post"); // Update the path accordingly
// Define the allowed book values
var Books = [
    'ge', 'exo'
];
// Sample data for bibleVerse field
var sampleBibleVerse = {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, post_1.default.updateMany({}, {
                        $set: {
            ...
            case 2:
                ...
                throw error_1; // Re-throw to ensure the disconnection happens
